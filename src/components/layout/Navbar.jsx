    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-4 sm:px-6 backdrop-blur-md transition-colors">
      ...
      <div className="flex items-center gap-3 flex-1 min-w-0 max-w-xl">
        ...
        <div className="hidden sm:block relative flex-1 min-w-0 max-w-md">
          <button
            onClick={() => setShowSearchDropdown(!showSearchDropdown)}
            aria-label="Search BOMs, work orders, invoices, and server logs"
            ...
            <div className="fixed top-16 left-4 right-4 sm:absolute sm:top-full sm:left-0 sm:right-auto sm:mt-2 sm:w-full sm:min-w-[280px] sm:max-w-md z-50 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 shadow-2xl overflow-x-hidden animate-in fade-in zoom-in-95">
              <div className="flex items-center justify-between px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 border-b border-slate-100 dark:border-slate-800 mb-1">
                ...
                <button
                  ...
                  className="text-indigo-600 dark:text-indigo-400 hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo-500"
                >
                  Open ⌘K
                </button>
              </div>
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div className="hidden md:flex items-center h-10 rounded-xl bg-slate-100 dark:bg-slate-950 p-1 border border-slate-200/80 dark:border-slate-800">
          <button
            ...
            aria-label="Switch to Company ERP view mode"
            className={`flex items-center gap-1.5 h-8 px-3 text-xs font-semibold rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-all ${
              tenantMode === 'tenant'
          ...
          <button
            ...
            aria-label="Switch to Server Admin infrastructure view mode"
            className={`flex items-center gap-1.5 h-8 px-3 text-xs font-semibold rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-all ${
        ...
        <button
          ...
          aria-label="Open Mobile Companion App UI Simulator"
          className="hidden md:flex items-center gap-1.5 h-10 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-colors shadow-2xs"
          title="Open Mobile Companion App UI Simulator"
        >
          <Smartphone className="h-3.5 w-3.5 text-emerald-500" aria-hidden="true" />
              ...
              <div className="absolute right-0 mt-2 w-60 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-1.5 shadow-xl z-50 animate-in fade-in zoom-in-95">
                ...
                {organizations.map((org) => (
                  <button
                    ...
                    className={`w-full flex flex-col text-left px-3 py-2 rounded-lg text-xs font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-colors ${
            ...
            <div className="absolute right-0 mt-2 w-72 sm:w-80 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95">
              <div className="flex items-center justify-between p-4 border-b border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50">
                ...
                {unreadCount > 0 && (
                  <button
                    onClick={markAllRead}
                    className="text-[11px] font-semibold text-indigo-600 dark:text-indigo-400 hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo-500"
                  >
                    Mark all read
                  </button>
                )}
                ...
                {notifications.map((n) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="text-xs font-semibold text-slate-900 dark:text-white">{n.title}</h3>
        ...
        <div className="relative flex items-center shrink-0">
          <button
            ...
            className="flex items-center gap-2 rounded-xl p-0.5 hover:bg-slate-100 dark:hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-colors"
          >
            <img
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 shadow-2xl z-50 animate-in fade-in zoom-in-95">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 transition-colors"
              >
